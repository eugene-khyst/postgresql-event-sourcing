...
public class OrderEventRepository {
  ...
  public void createAggregateIfNotExists(UUID aggregateId) {
    jdbcTemplate.update(
        "INSERT INTO ORDER_AGGREGATE (ID, VERSION) VALUES (?, ?) ON CONFLICT DO NOTHING",
        aggregateId,
        0);
  }
  ...
  public void createSubscription(String subscriptionGroup) {
    jdbcTemplate.update(
        "INSERT INTO ORDER_EVENT_OUTBOX (SUBSCRIPTION_GROUP, LAST_ID) VALUES (?, ?) ON CONFLICT DO NOTHING",
        subscriptionGroup,
        0);
  }
